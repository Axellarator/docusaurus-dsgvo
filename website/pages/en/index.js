    ...
    const Description = () => (
      <Block background="dark">
        {[
          {
            content:
              'Auch hier könnte etwas nützliches stehen',
