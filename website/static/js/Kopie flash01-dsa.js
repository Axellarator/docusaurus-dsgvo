...
var sumProzent		= [];	// Werte pro Karte
	...
	const iterator = Loesung.values(); //https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Global_Objects/Array/values
		...
		for(const value of iterator) {
			...
			if((!Checkbox[y].checked && value) || (Checkbox[y].checked && !value)){ // Falsch: Richtig nicht angekreuzt und Falsch angekreuzt
				document.getElementById(anzAnt).style.color = "blue"; 				// Checkbox[y].checked = false; Angekreuztes nicht löschen
				prozZaehler--
			}
		...
		arrEingaben[aktKarte] = arrMaske; // Werte aus arrMaske an arrEingaben übergeben
		...
		sumProzent[aktKarte] = aktProzent;					//Zwischenspeichern im Array 
